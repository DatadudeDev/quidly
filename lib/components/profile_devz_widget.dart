...
import 'profile_devz_model.dart';
export 'profile_devz_model.dart';

class ProfileDevzWidget extends StatefulWidget {
  const ProfileDevzWidget({
    Key? key,
    this.parameter1,
    this.parameter2,
    this.parameter3,
  ...
  @override
  _ProfileDevzWidgetState createState() => _ProfileDevzWidgetState();
}

class _ProfileDevzWidgetState extends State<ProfileDevzWidget> {
  late ProfileDevzModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileDevzModel());
                    ...
                    children: [
                        ...
                        child: StreamBuilder<List<UserPostsRecord>>(
                          stream: queryUserPostsRecord(
                            queryBuilder: (userPostsRecord) =>
                                userPostsRecord.where('postUser',
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            columnUserPostsRecord.imageURL,
                                            width: 100.0,
                                            height: 100.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                columnUserPostsRecord.postPoll,
                                                style:
                      ...
                      StreamBuilder<List<UserPostsRecord>>(
                        stream: queryUserPostsRecord(
                          queryBuilder: (userPostsRecord) => userPostsRecord
                              .where('postUser', isEqualTo: widget.parameter3)
                      ...
                      StreamBuilder<List<UsersRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UsersRecord> socialFeedUsersRecordList =
                              snapshot.data!;
                          if (socialFeedUsersRecordList.isEmpty) {
                            return Center(
                              child: Image.asset(
                                'assets/images/emptyPosts@2x.png',
                                width: MediaQuery.sizeOf(context).width * 0.5,
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(
                                  socialFeedUsersRecordList.length,
                                  (socialFeedIndex) {
                                final socialFeedUsersRecord =
                                    socialFeedUsersRecordList[socialFeedIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 2.0, 0.0, 2.0),
                                  child: Container(
